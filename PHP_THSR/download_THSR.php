...
// Remove all the .xml and .zip in THSR dir.
$files = glob("*.xml");
...
// High speed rail
$zipfile = file_get_contents("http://www3.thsrc.com.tw:8080/XML/allXML.zip");
$fp = fopen("/var/www/html/THSR/THSRallXML.zip", "w");
fwrite($fp, $zipfile);
fclose($fp);
